...
parser.add_argument('--function_type', type=str, default='hamiltonian', help='function type for ode network')
...
parser.add_argument('--name', type=str, default="HAM", help="HAM")
parser.add_argument('--feature_dim', type=int, default=3, help="2d,3d")

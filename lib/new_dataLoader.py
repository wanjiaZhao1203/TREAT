...
class ParseData(object):
    ...
    def load_data(self,sample_percent,batch_size,data_type="train",cut_num=5000):
        ...
        if self.suffix == '_multi_springs_simpled5' or self.suffix == '_multi_large_springs_simpled5' or self.suffix == 'multi_large_springs_damped5' or self.suffix == '_multi_large_forced_spring5'or self.suffix == "_springs_simpled_long5" or self.suffix == "_charged5" or self.suffix == '_forced_spring5' or self.suffix == '_springs_damped5' or self.suffix == '_pendulum3'or self.suffix == '_motion'or self.suffix == '_motion_dance'or self.suffix == '_motion_run' or self.suffix == '_attractor2':

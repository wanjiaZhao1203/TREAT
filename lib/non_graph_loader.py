...
class ParseData(object):
    ...
    def __init__(self, dataset_path,args,suffix = '_attractor2',mode="interp"):
    ...
    def load_data(self,sample_percent,batch_size,data_type="train",cut_num=5000):
        ...
        if self.suffix == "_springs5" or self.suffix == "_charged5" or self.suffix == '_forced_spring5'or self.suffix == '_attractor2':

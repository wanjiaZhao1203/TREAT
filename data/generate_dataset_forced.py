...
from synthetic_sim_forced import  SpringExternalSim
import time
import os
import numpy as np
import argparse
...
parser.add_argument('--simulation', type=str, default='forced_spring',
...
if args.simulation == 'forced_spring':
    sim = SpringExternalSim(noise_var=0.0, n_balls=args.n_balls)
    suffix = "_multi_large_forced_spring"
else:
...
if args.simulation =="forced_spring":
    ...
    spring_external_dir=os.path.join('forced_spring')
